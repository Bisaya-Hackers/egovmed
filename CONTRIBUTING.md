...
- `cd backend && npm test` passes. All 18 must stay green; regressions block merge.
...
- **All 18 backend tests stay green at every commit.** Regressions block merge in CI.
