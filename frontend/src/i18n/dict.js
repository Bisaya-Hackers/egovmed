...
export const DICT = {
  en: {
    ...
    mpinResetSending: 'Sending…',
    mpinResetSent: (phone) => `We texted a reset code to ${phone}. It expires in 10 minutes.`,
    switchAccountTitle: 'Use a different number',
    switchAccountSub: 'Enter the mobile number of the eGovPH account you want to sign in with.',
    switchPhoneLabel: 'Mobile number', switchPhonePlaceholder: '0917 123 4567',
    switchAccountConfirm: 'Continue', switchAccountCancel: 'Cancel',
    switchAccountDone: (phone) => `Switched to ${phone}. Enter that account's MPIN.`,
  ...
  tl: {
    ...
    mpinResetSending: 'Ipinapadala…',
    mpinResetSent: (phone) => `Nag-text kami ng reset code sa ${phone}. Mag-e-expire ito sa loob ng 10 minuto.`,
    switchAccountTitle: 'Gumamit ng ibang numero',
    switchAccountSub: 'Ilagay ang mobile number ng eGovPH account na gusto mong gamitin.',
    switchPhoneLabel: 'Mobile number', switchPhonePlaceholder: '0917 123 4567',
    switchAccountConfirm: 'Magpatuloy', switchAccountCancel: 'Kanselahin',
    switchAccountDone: (phone) => `Lumipat sa ${phone}. Ilagay ang MPIN ng account na iyon.`,
...
export const CONST = {
  ...
  // phone is the masked display form; phoneE164 is the canonical value the sign-in screen
  // masks at render time, so switching to a different number reuses the same masking rule.
  phone: '+63 961 ••• 8546',
  phoneE164: '+639615558546',
};
