...
export const DICT = {
  en: {
    ...
    messageReplySent: 'Message sent', messageStaffAck: 'PGH replied', messageRecordUploaded: 'Record uploaded',
  ...
  tl: {
    ...
    messageReplySent: 'Naipadala ang mensahe', messageStaffAck: 'Sumagot ang PGH', messageRecordUploaded: 'Na-upload ang rekord',
