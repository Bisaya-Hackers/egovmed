...
export const DICT = {
  en: {
    ...
    benefitOn: 'Active', benefitOff: 'Not active', benefitAdd: 'Add', benefitAdding: 'Adding…', benefitComingSoon: 'Coming soon', benefitAddCta: 'Add a benefit', benefitsNone: 'No benefits added yet.', benefitCatalogEmpty: 'You’ve added every available benefit.', benefitCovered: 'Already covered', languageLabel: 'Language', textSizeLabel: 'Text size', notAvailable: 'Not provided',
