...
export const DICT = {
  en: {
    ...
    messageReplySent: 'Message sent', messageStaffAck: 'PGH replied', messageRecordUploaded: 'Record uploaded', messageBenefitAdded: 'Benefit added',
    messagePaymentConfirmed: 'Payment confirmed', messageReportFiled: 'Report filed',
  ...
  tl: {
    ...
    messageReplySent: 'Naipadala ang mensahe', messageStaffAck: 'Sumagot ang PGH', messageRecordUploaded: 'Na-upload ang rekord', messageBenefitAdded: 'Idinagdag ang benepisyo',
    messagePaymentConfirmed: 'Nakumpirma ang bayad', messageReportFiled: 'Naisumite ang report',
