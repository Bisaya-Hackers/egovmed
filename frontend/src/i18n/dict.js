...
export const DICT = {
  en: {
    ...
    benefitOn: 'Active', benefitOff: 'Not active', benefitAdd: 'Add', benefitAdding: 'Adding…', benefitComingSoon: 'Coming soon', benefitAddCta: 'Add a benefit', benefitsNone: 'No benefits added yet.', languageLabel: 'Language', textSizeLabel: 'Text size', notAvailable: 'Not provided',
  ...
  tl: {
    ...
    benefitOn: 'Aktibo', benefitOff: 'Hindi aktibo', benefitAdd: 'Idagdag', benefitAdding: 'Idinaragdag…', benefitComingSoon: 'Malapit na', benefitAddCta: 'Magdagdag ng benepisyo', benefitsNone: 'Wala pang naidagdag na benepisyo.', languageLabel: 'Wika', textSizeLabel: 'Laki ng teksto', notAvailable: 'Walang inilagay',
