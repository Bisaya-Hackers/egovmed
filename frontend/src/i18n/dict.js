...
export const DICT = {
  en: {
    ...
    verifiedBadge: 'Verified', verifiedFrom: 'Verified from', paidBadge: 'Paid',
    ...
    benefitOn: 'Active', benefitOff: 'Not active', languageLabel: 'Language', textSizeLabel: 'Text size', notAvailable: 'Not provided',
  ...
  tl: {
    ...
    verifiedBadge: 'Verified', verifiedFrom: 'Verified mula sa', paidBadge: 'Bayad na',
    ...
    benefitOn: 'Aktibo', benefitOff: 'Hindi aktibo', languageLabel: 'Wika', textSizeLabel: 'Laki ng teksto', notAvailable: 'Walang inilagay',
